...
<body>
    <div id="strona">
		...
		<div id="artykuly">
			...
			mysqli_query($conn,"UPDATE Ksiazka SET czy_dostepna='Tak' WHERE id_ksiazki='".$_POST['ksiazka']."';");
			?>
				<h2> Formularz oddania książki: </h2>
				...
				<h2> Wypożyczenia: </h2>
				<?php
					if($_POST!=NULL)mysqli_query($conn,"DELETE FROM Wypozycza WHERE id_czytelnika='".$_POST[czytelnik]."' AND id_ksiazki='".$_POST[ksiazka]."'");
